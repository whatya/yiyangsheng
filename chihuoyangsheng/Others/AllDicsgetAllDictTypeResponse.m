...
@implementation AllDicsgetAllDictTypeResponse
...
- (id) initWithXml: (DDXMLElement*) __node __request:(AllDicsRequestResultHandler*) __request {
    if(self = [self init])
    {
        ...
        {
            [self.items addObject:(AllDicsdictType*)[__request createObject:child type:[AllDicsdictType class]]];
        }
...
{
    for (AllDicsdictType* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[AllDicsdictType class] name:@"return" URI:@"" parent:__parent skipNullProperty:__request.SkipNullProperties];
...
- (void)removeObjectIdenticalTo:(AllDicsdictType*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(AllDicsdictType*)anObject {
...
+ (id)array {
	return [[ AllDicsgetAllDictTypeResponse alloc] init];
}

+ (id)arrayWithObject:(AllDicsdictType*)anObject {
	return [[ AllDicsgetAllDictTypeResponse alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const AllDicsdictType* *)objects count:(NSUInteger)cnt {
	return [[ AllDicsgetAllDictTypeResponse alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(AllDicsdictType*)firstObj, ... {
	AllDicsgetAllDictTypeResponse* a = [ AllDicsgetAllDictTypeResponse array];
	id eachObject;
...
- (id)initWithObjects:(AllDicsdictType*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ AllDicsgetAllDictTypeResponse alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ AllDicsgetAllDictTypeResponse alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ AllDicsgetAllDictTypeResponse alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ AllDicsgetAllDictTypeResponse alloc] initWithCapacity:numItems];
}
