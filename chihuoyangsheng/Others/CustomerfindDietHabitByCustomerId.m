...
@implementation CustomerfindDietHabitByCustomerId
    @synthesize arg0;

+ (CustomerfindDietHabitByCustomerId *)createWithXml:(DDXMLElement *)__node __request:(CustomerRequestResultHandler*) __request
{
