...
@implementation DicgetDictByTypeIdResponse
...
+ (id)array {
	return [[ DicgetDictByTypeIdResponse alloc] init];
}

+ (id)arrayWithObject:(Dicdict*)anObject {
	return [[ DicgetDictByTypeIdResponse alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const Dicdict* *)objects count:(NSUInteger)cnt {
	return [[ DicgetDictByTypeIdResponse alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(Dicdict*)firstObj, ... {
	DicgetDictByTypeIdResponse* a = [ DicgetDictByTypeIdResponse array];
	id eachObject;
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ DicgetDictByTypeIdResponse alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ DicgetDictByTypeIdResponse alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ DicgetDictByTypeIdResponse alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ DicgetDictByTypeIdResponse alloc] initWithCapacity:numItems];
}
