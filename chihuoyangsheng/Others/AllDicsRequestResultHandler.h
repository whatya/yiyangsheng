...
@protocol AllDicsIReferenceObject
@end
    
@class AllDicsRequestResultHandler;
typedef void (^AllDicsCLB)(AllDicsRequestResultHandler *);

@interface AllDicsRequestResultHandler : NSObject
...
@property (nonatomic,copy) AllDicsCLB Callback;
