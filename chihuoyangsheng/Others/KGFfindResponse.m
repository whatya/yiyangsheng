...
@implementation KGFfindResponse
...
- (id) initWithXml: (DDXMLElement*) __node __request:(KGFRequestResultHandler*) __request {
    if(self = [self init])
    {
        ...
        {
            [self.items addObject:(KGFsuggestions*)[__request createObject:child type:[KGFsuggestions class]]];
        }
...
{
    for (KGFsuggestions* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[KGFsuggestions class] name:@"return" URI:@"" parent:__parent skipNullProperty:NO];
...
- (void)removeObjectIdenticalTo:(KGFsuggestions*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(KGFsuggestions*)anObject {
...
+ (id)array {
	return [[ KGFfindResponse alloc] init];
}

+ (id)arrayWithObject:(KGFsuggestions*)anObject {
	return [[ KGFfindResponse alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const KGFsuggestions* *)objects count:(NSUInteger)cnt {
	return [[ KGFfindResponse alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(KGFsuggestions*)firstObj, ... {
	KGFfindResponse* a = [ KGFfindResponse array];
	id eachObject;
...
- (id)initWithObjects:(KGFsuggestions*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ KGFfindResponse alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ KGFfindResponse alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ KGFfindResponse alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ KGFfindResponse alloc] initWithCapacity:numItems];
}
