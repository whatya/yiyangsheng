...
@implementation CustomerinsertDietHabitResponse

+ (CustomerinsertDietHabitResponse *)createWithXml:(DDXMLElement *)__node __request:(CustomerRequestResultHandler*) __request
{
