...
#import "KGFSoapError.h"



@implementation KGFRequestResultHandler
...
if ((self=[super init])) {
        ...
        if(!classNames)
        {
            ...
            [KGFsuggestions class],@"http://service.suggestions.app/^^suggestions",
            [KGFsuggestionsReply class],@"http://service.suggestions.app/^^suggestionsReply",
            nil]; 
...
-(id)createObject: (DDXMLElement*) node type:(Class) type
{
    ...
    DDXMLNode* nilAttr=[KGFHelper getAttribute:node name:@"nil" url:XSI];
    if(nilAttr!=nil && [[nilAttr stringValue]boolValue])
    {
        return nil;
    }

    DDXMLNode* typeAttr=[KGFHelper getAttribute:node name:@"type" url:XSI];
    if(typeAttr !=nil)
    {
    ...
    DDXMLNode* hrefAttr=[KGFHelper getAttribute:node name:@"href" url:@""];
    if(hrefAttr==nil)
    {
        hrefAttr=[KGFHelper getAttribute:node name:@"ref" url:@""];
    }
    if(hrefAttr!=nil)
    {
...
-(id) createInstance:(Class) type node: (DDXMLNode*)node request :(KGFRequestResultHandler *)request
{
    ...
    id (*func)(id, SEL, DDXMLNode*, KGFRequestResultHandler *) = (void *)imp;
...
-(void)setResponse:(NSData *)response
{
    ...
    OutputBody=[KGFHelper getNode:__root  name:@"Body" URI:@"http://schemas.xmlsoap.org/soap/envelope/"];
    OutputHeader=[KGFHelper getNode:__root  name:@"Header" URI:@"http://schemas.xmlsoap.org/soap/envelope/"];
    DDXMLElement* fault=[KGFHelper getNode:OutputBody  name:@"Fault" URI:@"http://schemas.xmlsoap.org/soap/envelope/"];
    if(fault!=nil)
    {
        DDXMLElement* faultString=[KGFHelper getNode:fault name:@"faultstring"];
        id faultObj=nil;
        DDXMLElement* faultDetail=[KGFHelper getNode:fault name:@"detail"];
        if(faultDetail!=nil)
        {
        ...
        OutputFault=[[KGFSoapError alloc] initWithDetails:[faultString stringValue] details:faultObj];
    }
}
