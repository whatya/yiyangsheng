...
@protocol CookBookIReferenceObject
@end
    
@class CookBookRequestResultHandler;
typedef void (^CookBookCLB)(CookBookRequestResultHandler *);

@interface CookBookRequestResultHandler : NSObject
...
@property (nonatomic,copy) CookBookCLB Callback;
