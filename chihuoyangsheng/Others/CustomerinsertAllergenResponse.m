...
@implementation CustomerinsertAllergenResponse

+ (CustomerinsertAllergenResponse *)createWithXml:(DDXMLElement *)__node __request:(CustomerRequestResultHandler*) __request
{
