...
{
    DDXMLNode* child=[KGFHelper getAttribute:node name:name];
    return child!=nil;
}
...
{
    DDXMLElement* child=[KGFHelper getNode:node name:name index:index];
    if(child!=nil)
    {
        DDXMLNode* nilAttr=[KGFHelper getAttribute:child name:@"nil" url:XSI];
        return nilAttr==nil;
    }
    return NO;
}
