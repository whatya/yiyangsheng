...
#import "CustomerinsertAllergenResponse.h"
#import "CustomerfindDietHabitByCustomerId.h"
#import "CustomerdietHabit.h"
#import "Customerlogin.h"
#import "CustomerloginResponse.h"
#import "CustomerdeleteAllergenByCustomerId.h"
...
#import "CustomerinsertDietHabitResponse.h"
...
#import "CustomerdeleteDietHabitByCustomerId.h"
...
@implementation CustomerRequestResultHandler
...
if ((self=[super init])) {
        ...
        if(!classNames)
        {
            ...
            [CustomerinsertAllergen class],@"http://service.customer.app/^^insertAllergen",
            [Customerallergen class],@"http://service.customer.app/^^allergen",
            [CustomerinsertAllergenResponse class],@"http://service.customer.app/^^insertAllergenResponse",
            [CustomerfindDietHabitByCustomerId class],@"http://service.customer.app/^^findDietHabitByCustomerId",
            [CustomerdietHabit class],@"http://service.customer.app/^^dietHabit",
            [Customerlogin class],@"http://service.customer.app/^^login",
            [CustomerloginResponse class],@"http://service.customer.app/^^loginResponse",
            [CustomerdeleteAllergenByCustomerId class],@"http://service.customer.app/^^deleteAllergenByCustomerId",
            [CustomerdeleteAllergenByCustomerIdResponse class],@"http://service.customer.app/^^deleteAllergenByCustomerIdResponse",
            [CustomergetCustomerByLoginName class],@"http://service.customer.app/^^getCustomerByLoginName",
            [CustomergetCustomerByLoginNameResponse class],@"http://service.customer.app/^^getCustomerByLoginNameResponse",
            [Customercustomer class],@"http://service.customer.app/^^customer",
            [CustomerinsertDietHabit class],@"http://service.customer.app/^^insertDietHabit",
            [CustomerinsertDietHabitResponse class],@"http://service.customer.app/^^insertDietHabitResponse",
            [CustomerfindAllergenByCustomerId class],@"http://service.customer.app/^^findAllergenByCustomerId",
            [CustomersaveCustomer class],@"http://service.customer.app/^^saveCustomer",
            [CustomerhealthRecord class],@"http://service.customer.app/^^healthRecord",
            [CustomersaveCustomerResponse class],@"http://service.customer.app/^^saveCustomerResponse",
            [CustomerdeleteDietHabitByCustomerId class],@"http://service.customer.app/^^deleteDietHabitByCustomerId",
            [CustomerdeleteDietHabitByCustomerIdResponse class],@"http://service.customer.app/^^deleteDietHabitByCustomerIdResponse",
            nil]; 
...
{
    DDXMLNode* refAttr=[CustomerHelper getAttribute:node name:@"Ref" url:MS_SERIALIZATION_NS];
    if(refAttr!=nil)
    {
        return [referencesTable objectForKey:[refAttr stringValue]];
    }
    
    DDXMLNode* nilAttr=[CustomerHelper getAttribute:node name:@"nil" url:XSI];
    if(nilAttr!=nil && [[nilAttr stringValue]boolValue])
    {
        return nil;
    }

    DDXMLNode* typeAttr=[CustomerHelper getAttribute:node name:@"type" url:XSI];
    if(typeAttr !=nil)
    {
    ...
    DDXMLNode* hrefAttr=[CustomerHelper getAttribute:node name:@"href" url:@""];
    if(hrefAttr==nil)
    {
        hrefAttr=[CustomerHelper getAttribute:node name:@"ref" url:@""];
    }
    if(hrefAttr!=nil)
    {
    ...
    DDXMLNode* idAttr=[CustomerHelper getAttribute:node name:@"Id" url:MS_SERIALIZATION_NS];
    if(idAttr!=nil)
    {
...
-(id) createInstance:(Class) type node: (DDXMLNode*)node request :(CustomerRequestResultHandler *)request
{
    ...
    id (*func)(id, SEL, DDXMLNode*, CustomerRequestResultHandler *) = (void *)imp;
...
-(DDXMLElement*) writeElement:(id)obj type:(Class)type name: (NSString*)name URI: (NSString*) URI parent:(DDXMLElement*) parent skipNullProperty:(BOOL)skipNullProperty
{
    ...
    if([obj conformsToProtocol:@protocol(CustomerIReferenceObject)])
    {
...
-(void)setResponse:(NSData *)response
{
    ...
    OutputBody=[CustomerHelper getNode:__root  name:@"Body" URI:@"http://schemas.xmlsoap.org/soap/envelope/"];
    OutputHeader=[CustomerHelper getNode:__root  name:@"Header" URI:@"http://schemas.xmlsoap.org/soap/envelope/"];
    DDXMLElement* fault=[CustomerHelper getNode:OutputBody  name:@"Fault" URI:@"http://schemas.xmlsoap.org/soap/envelope/"];
    if(fault!=nil)
    {
        DDXMLElement* faultString=[CustomerHelper getNode:fault name:@"faultstring"];
        id faultObj=nil;
        DDXMLElement* faultDetail=[CustomerHelper getNode:fault name:@"detail"];
        if(faultDetail!=nil)
        {
        ...
        OutputFault=[[CustomerSoapError alloc] initWithDetails:[faultString stringValue] details:faultObj];
    }
}
