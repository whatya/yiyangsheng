...
@implementation DicgetDictByTypeCodeResponse

@synthesize items;

+ (DicgetDictByTypeCodeResponse *)createWithXml:(DDXMLElement *)__node __request:(DicRequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(DicRequestResultHandler*) __request {
    if(self = [self init])
    {
        ...
        {
            [self.items addObject:(Dicdict*)[__request createObject:child type:[Dicdict class]]];
        }
...
{
    for (Dicdict* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[Dicdict class] name:@"return" URI:@"" parent:__parent skipNullProperty:__request.SkipNullProperties];
...
- (void)removeObjectIdenticalTo:(Dicdict*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(Dicdict*)anObject {
...
+ (id)array {
	return [[ DicgetDictByTypeCodeResponse alloc] init];
}

+ (id)arrayWithObject:(Dicdict*)anObject {
	return [[ DicgetDictByTypeCodeResponse alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const Dicdict* *)objects count:(NSUInteger)cnt {
	return [[ DicgetDictByTypeCodeResponse alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(Dicdict*)firstObj, ... {
	DicgetDictByTypeCodeResponse* a = [ DicgetDictByTypeCodeResponse array];
	id eachObject;
...
- (id)initWithObjects:(Dicdict*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ DicgetDictByTypeCodeResponse alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ DicgetDictByTypeCodeResponse alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ DicgetDictByTypeCodeResponse alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ DicgetDictByTypeCodeResponse alloc] initWithCapacity:numItems];
}
