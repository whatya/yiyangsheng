...
@implementation CustomerfindAllergenByCustomerIdResponse
...
- (id) initWithXml: (DDXMLElement*) __node __request:(CustomerRequestResultHandler*) __request {
    if(self = [self init])
    {
        ...
        {
            [self.items addObject:(Customerallergen*)[__request createObject:child type:[Customerallergen class]]];
        }
...
{
    for (Customerallergen* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[Customerallergen class] name:@"return" URI:@"" parent:__parent skipNullProperty:__request.SkipNullProperties];
...
- (void)removeObjectIdenticalTo:(Customerallergen*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(Customerallergen*)anObject {
...
+ (id)array {
	return [[ CustomerfindAllergenByCustomerIdResponse alloc] init];
}

+ (id)arrayWithObject:(Customerallergen*)anObject {
	return [[ CustomerfindAllergenByCustomerIdResponse alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const Customerallergen* *)objects count:(NSUInteger)cnt {
	return [[ CustomerfindAllergenByCustomerIdResponse alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(Customerallergen*)firstObj, ... {
	CustomerfindAllergenByCustomerIdResponse* a = [ CustomerfindAllergenByCustomerIdResponse array];
	id eachObject;
...
- (id)initWithObjects:(Customerallergen*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ CustomerfindAllergenByCustomerIdResponse alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ CustomerfindAllergenByCustomerIdResponse alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ CustomerfindAllergenByCustomerIdResponse alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ CustomerfindAllergenByCustomerIdResponse alloc] initWithCapacity:numItems];
}
