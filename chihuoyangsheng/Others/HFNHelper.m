...
{
    DDXMLNode* child=[HFNHelper getAttribute:node name:name];
    return child!=nil;
}
...
{
    DDXMLElement* child=[HFNHelper getNode:node name:name index:index];
    if(child!=nil)
    {
        DDXMLNode* nilAttr=[HFNHelper getAttribute:child name:@"nil" url:XSI];
        return nilAttr==nil;
    }
    return NO;
}
