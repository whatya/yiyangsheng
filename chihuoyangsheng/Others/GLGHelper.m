...
{
    DDXMLNode* child=[GLGHelper getAttribute:node name:name];
    return child!=nil;
}
...
{
    DDXMLElement* child=[GLGHelper getNode:node name:name index:index];
    if(child!=nil)
    {
        DDXMLNode* nilAttr=[GLGHelper getAttribute:child name:@"nil" url:XSI];
        return nilAttr==nil;
    }
    return NO;
}
