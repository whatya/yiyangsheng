...
@implementation GuidefindResponse
...
- (id) initWithXml: (DDXMLElement*) __node __request:(GuideRequestResultHandler*) __request {
    if(self = [self init])
    {
        ...
        {
            [self.items addObject:(Guidesuggestions*)[__request createObject:child type:[Guidesuggestions class]]];
        }
...
{
    for (Guidesuggestions* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[Guidesuggestions class] name:@"return" URI:@"" parent:__parent skipNullProperty:__request.SkipNullProperties];
...
- (void)removeObjectIdenticalTo:(Guidesuggestions*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(Guidesuggestions*)anObject {
...
+ (id)array {
	return [[ GuidefindResponse alloc] init];
}

+ (id)arrayWithObject:(Guidesuggestions*)anObject {
	return [[ GuidefindResponse alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const Guidesuggestions* *)objects count:(NSUInteger)cnt {
	return [[ GuidefindResponse alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(Guidesuggestions*)firstObj, ... {
	GuidefindResponse* a = [ GuidefindResponse array];
	id eachObject;
...
- (id)initWithObjects:(Guidesuggestions*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ GuidefindResponse alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ GuidefindResponse alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ GuidefindResponse alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ GuidefindResponse alloc] initWithCapacity:numItems];
}
