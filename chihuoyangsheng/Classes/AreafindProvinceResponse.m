...
@implementation AreafindProvinceResponse

@synthesize items;

+ (AreafindProvinceResponse *)createWithXml:(DDXMLElement *)__node __request:(AreaRequestResultHandler*) __request
{
...
+ (id)array {
	return [[ AreafindProvinceResponse alloc] init];
}

+ (id)arrayWithObject:(Areaprovince*)anObject {
	return [[ AreafindProvinceResponse alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const Areaprovince* *)objects count:(NSUInteger)cnt {
	return [[ AreafindProvinceResponse alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(Areaprovince*)firstObj, ... {
	AreafindProvinceResponse* a = [ AreafindProvinceResponse array];
	id eachObject;
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ AreafindProvinceResponse alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ AreafindProvinceResponse alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ AreafindProvinceResponse alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ AreafindProvinceResponse alloc] initWithCapacity:numItems];
}
