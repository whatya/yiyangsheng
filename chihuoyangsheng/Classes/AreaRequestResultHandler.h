...
@protocol AreaIReferenceObject
@end
    
@class AreaRequestResultHandler;
typedef void (^AreaCLB)(AreaRequestResultHandler *);

@interface AreaRequestResultHandler : NSObject
...
@property (nonatomic,copy) AreaCLB Callback;
