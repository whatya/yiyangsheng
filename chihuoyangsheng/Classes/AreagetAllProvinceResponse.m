...
@implementation AreagetAllProvinceResponse

@synthesize items;

+ (AreagetAllProvinceResponse *)createWithXml:(DDXMLElement *)__node __request:(AreaRequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(AreaRequestResultHandler*) __request {
    if(self = [self init])
    {
        ...
        {
            [self.items addObject:(Areaprovince*)[__request createObject:child type:[Areaprovince class]]];
        }
...
{
    for (Areaprovince* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[Areaprovince class] name:@"return" URI:@"" parent:__parent skipNullProperty:__request.SkipNullProperties];
...
- (Areaprovince*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(Areaprovince*)anObject {
...
- (BOOL)containsObject:(Areaprovince*)anObject {
...
- (NSUInteger)indexOfObject:(Areaprovince*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(Areaprovince*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(Areaprovince*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(Areaprovince*)anObject inRange:(NSRange)range {
...
- (void)addObject:(Areaprovince*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(Areaprovince*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(Areaprovince*)anObject {
...
- (void)removeObject:(Areaprovince*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(Areaprovince*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(Areaprovince*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(Areaprovince*)anObject {
...
+ (id)array {
	return [[ AreagetAllProvinceResponse alloc] init];
}

+ (id)arrayWithObject:(Areaprovince*)anObject {
	return [[ AreagetAllProvinceResponse alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const Areaprovince* *)objects count:(NSUInteger)cnt {
	return [[ AreagetAllProvinceResponse alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(Areaprovince*)firstObj, ... {
	AreagetAllProvinceResponse* a = [ AreagetAllProvinceResponse array];
	id eachObject;
...
- (id)initWithObjects:(Areaprovince*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ AreagetAllProvinceResponse alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ AreagetAllProvinceResponse alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ AreagetAllProvinceResponse alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ AreagetAllProvinceResponse alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const Areaprovince* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(Areaprovince*, Areaprovince*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(Areaprovince*, Areaprovince*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(Areaprovince*, Areaprovince*, void *))compare context:(void *)context {
