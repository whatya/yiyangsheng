...
@protocol BaseFoodIReferenceObject
@end
    
@class BaseFoodRequestResultHandler;
typedef void (^BaseFoodCLB)(BaseFoodRequestResultHandler *);

@interface BaseFoodRequestResultHandler : NSObject
...
@property (nonatomic,copy) BaseFoodCLB Callback;
